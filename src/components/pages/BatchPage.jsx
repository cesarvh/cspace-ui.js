...
export default class BatchPage extends Component {
  ...
  filter(value) {
    ...
    this.setState({
      filterValue: value,
      searchDescriptor: searchDescriptor.set('searchQuery', 
      updatedSearchQuery),
    });
  }
  ...
  handleModalInvokeButtonClick(reportMetadata, invocationDescriptor) {
    ...
    // const createsNewFocus = (get('createsNewFocus') === 'true');
    ...
    //   } else {
    //     if (closeModal) {
    //       closeModal(BatchModal.modalName);
    //     }
    //   }
    // }

    // if (invoke) {
    //   invoke(config, invocationItem, {
    //     csid, recordType
